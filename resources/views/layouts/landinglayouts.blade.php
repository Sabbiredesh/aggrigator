                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu menu">
                            <li><a class="dropdown-item text-center" href="#">eCommerce Merchants</a>
                                <ul class="submenu2">
                                    <li class="dropdown-item "><a href=" {{ url('overview') }} "
                                            class="text-dark">Overview</a></li>
                                    ...
                                    <li class="dropdown-item"><a href="" class="text-dark">Global Fulfillment</a>
                                    </li>
                                </ul>
                        ...
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            @auth
                                @if (  Auth::user()->role_id == 1)
                                    <a href="{{ url('/admin/dashboard') }}"
                                        class="text-sm text-gray-700 dark:text-gray-500 underline" id="signing">Home</a>
                            ...
                            @else
                                <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"
                                    id="signing">Sign In</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline" id="signup">Sign
                                        Up</a>
                                @endif
                            @endauth
                        </div>
